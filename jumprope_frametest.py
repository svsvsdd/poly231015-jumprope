...
# show_frame_interval = 1  # 1 프레임마다 이미지를 업데이트 (30fps)
show_frame_interval = int(1000 / fps)
frame_counter = 0
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        # if frame_counter >= show_frame_interval :
        # # display.
        #     cv2.imshow("Jumprope Pose", image)
        #     frame_counter = 0  # frame_counter를 리셋하여 1프레임 지났음을 나타냄
        # # out.write(image)
