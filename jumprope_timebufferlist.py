...
class BufferList2:
    def __init__(self, time_buffer, default_value=None):
        self.buffer = [default_value for _ in range(time_buffer)]
...
time_difference = BufferList2(time_buffer)
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        cv2.putText(
            image,
            "Count:" + str(count),
            (int(image_width * 0.6), int(image_height * 0.3)),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.5,
            (0, 255, 0),
            1,
        ...
        cv2.putText(
            image,
            "FPS:" + str(fps),
            (int(image_width * 0.05), int(image_height * 0.1)),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.5,
            (0, 0, 255),
            1,
        ...
        cv2.putText(
            image,
            "Jump delay:" + str(f_td),
            (int(image_width * 0.05), int(image_height * 0.2)),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.5,
            (0, 0, 255),
            1,
